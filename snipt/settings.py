...
MEDIA_ROOT = os.path.join(BASE_PATH, 'public', 'media', 'uploads')
...
STATIC_ROOT = os.path.join(BASE_PATH, 'public', 'static')
STATIC_URL = '/static/'

# Additional locations of static files
STATICFILES_DIRS = (
    os.path.join(BASE_PATH, 'public', 'media'),
)
...
TEMPLATE_DIRS = (
    os.path.join(BASE_PATH, 'snipt', 'templates')
)
